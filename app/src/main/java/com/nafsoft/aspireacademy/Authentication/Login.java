...
public class Login extends AppCompatActivity {
    ...
    /*
     * This section is for keeping logged in user login . On on start we check weather current user Available or not if so Redirect to MainActivity
     * Else keep going through login page
     */
    @Override
    ...
    /*
    * This section is to handle backPress action
    */

    public void onBackPressed() {

        AlertDialog.Builder builder = new AlertDialog.Builder(Login.this);
        builder.setMessage("Are You sure you want to quite the app?");
