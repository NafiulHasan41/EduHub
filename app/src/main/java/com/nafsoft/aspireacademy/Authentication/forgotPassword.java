...
public class forgotPassword extends AppCompatActivity {
    ...
    private void passwordReset(String inputEmail) {
        ...
        Query query = FirebaseDatabase.getInstance("https://aspireacademy-software-project-default-rtdb.firebaseio.com").getReference("Users").orderByChild("userEmail").equalTo(inputEmail);
